...
[VolumeComponentEditor(typeof(RaindropFX_URP))]
public class RaindropFX_URPEditor : VolumeComponentEditor {
    ...
    SerializedDataParameter tintWeight;
    ...
    public override void OnEnable() {
        base.OnEnable();
        var o = new PropertyFetcher<RaindropFX_URP>(serializedObject);
        ...
        tintWeight = Unpack(o.Find(x => x.tintWeight));
